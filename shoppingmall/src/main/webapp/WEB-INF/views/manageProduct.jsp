				...
				<div class="panel-body">
					...
					action="${contextRoot}/manage/products" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea name="description" path="description" rows="4" placeholder="Write a description for Product!" class="form-control"/>	
